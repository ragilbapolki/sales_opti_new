...
Route::get('/list-harga', 'StokERPController@page_listharga_erp')->name('page_listharga_erp');
Route::post('/list-harga/data', 'StokERPController@data_list_harga')->name('data_list_harga');
Route::post('/list-harga/data/view_data', 'StokERPController@viewdetail')->name('viewdetail_harga');
...
Route::get('/selectproduct-erp-bycode', 'StokERPController@select2product_bycode')->name('selectproductbycode.erp');
...
Route::get('/selectcust-erp', 'HomeController@selectcust_erp')->name('selectcust_erp'); //route untuk select2 nama customer
...
Route::get('/customer-erp', 'CustomerERPController@page_cust_aktivitas')->name('page_cust_aktivitas_erp');
...
Route::post('/custaktivitas-erp', 'CustomerERPController@search_cust_aktivitas')->name('search_cust_aktivitas_erp'); //json calender
Route::post('/tabelcustaktivitas', 'CustomerController@tabel_show_aktivitas')->name('tabel_show_aktivitas'); //json calender
Route::post('/tabelcustaktivitas-erp', 'CustomerERPController@tabel_show_aktivitas')->name('tabel_show_aktivitas_erp'); //json calender

Route::get('/customerccc', 'CustomerController@page_cust_ccc')->name('page_cust_ccc');
Route::get('/customerccc-erp', 'CustomerERPController@page_cust_ccc')->name('page_cust_ccc_erp');
Route::post('/customerccc', 'CustomerController@data_cust_ccc')->name('data_cust_ccc');
Route::post('/customerccc-erp', 'CustomerERPController@data_cust_ccc')->name('data_cust_ccc_erp');
